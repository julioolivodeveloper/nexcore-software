...
let clients = [
  { id: 1,  name: 'CBP Endless Ventures',    email: 'cbp@endless.com',           phone: '', company: 'CBP Endless Ventures',    address: '', created_at: '2024-01-01' },
  { id: 2,  name: 'Maria Caldera',           email: 'maria.caldera@email.com',   phone: '', company: '',                         address: '', created_at: '2024-01-01' },
  { id: 3,  name: 'Zoila Camacho',           email: 'zoila.camacho@email.com',   phone: '', company: '',                         address: '', created_at: '2024-01-01' },
  { id: 4,  name: 'Marizol Benavidez',       email: 'marizol.b@email.com',       phone: '', company: '',                         address: '', created_at: '2024-01-01' },
  { id: 5,  name: 'Jorge Beltran',           email: 'jorge.beltran@email.com',   phone: '', company: '',                         address: '', created_at: '2024-01-01' },
  { id: 6,  name: 'Samuel Martinez',         email: 'samuel.martinez@email.com', phone: '', company: '',                         address: '', created_at: '2024-01-01' },
  { id: 7,  name: 'Christopher Hernandez',   email: 'christopher.h@email.com',   phone: '', company: '',                         address: '', created_at: '2024-01-01' },
  { id: 8,  name: 'Nabor Saldivar',          email: 'nabor.saldivar@email.com',  phone: '', company: '',                         address: '', created_at: '2024-01-01' },
  { id: 9,  name: 'Kimberly Baker',          email: 'kimberly.baker@email.com',  phone: '', company: '',                         address: '', created_at: '2024-01-01' },
  { id: 10, name: 'Luis de Leon',            email: 'luis.deleon@email.com',     phone: '', company: '',                         address: '', created_at: '2024-01-01' },
  { id: 11, name: 'Claudia Ortega',          email: 'claudia.ortega@email.com',  phone: '', company: '',                         address: '', created_at: '2024-01-01' },
  { id: 12, name: 'Roofing & Siding Pro',    email: 'info@roofingsiding.com',    phone: '', company: 'Roofing & Siding Pro',      address: '', created_at: '2024-01-01' },
  { id: 13, name: 'Carniceria La Ideal',     email: 'carniceria@laideal.com',    phone: '', company: 'Carniceria La Ideal',       address: '', created_at: '2024-01-01' },
  { id: 14, name: 'Ana Tovar',               email: 'ana.tovar@email.com',       phone: '', company: '',                         address: '', created_at: '2024-01-01' },
  { id: 15, name: 'Nails Premium Studio',    email: 'info@nailspremium.com',     phone: '', company: 'Nails Premium Studio',      address: '', created_at: '2024-01-01' },
  { id: 16, name: 'Abel Huerta',             email: 'abel.huerta@email.com',     phone: '', company: '',                         address: '', created_at: '2024-01-01' },
  { id: 17, name: 'Alondra Dental Co',       email: 'info@alondradental.com',    phone: '', company: 'Alondra Dental Co',         address: '', created_at: '2024-01-01' },
  { id: 18, name: 'Oscar Martinez',          email: 'oscar.martinez@email.com',  phone: '', company: '',                         address: '', created_at: '2024-01-01' },
];
